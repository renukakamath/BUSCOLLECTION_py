    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String q ="/send_complaint?&login_id="+Login.login_id+"&complaint="+complaint;
                q = q.replace(" ","%20");
                JR.execute(q);
            }
        });
        ...
        JsonReq JR = new JsonReq();
        JR.json_response = (JsonResponse) SendComplaint.this;
        String q ="/view_complaints?login_id="+Login.login_id;
        q = q.replace(" ","%20");
        JR.execute(q);
        ...
        try {
            ...
            else if(method.equalsIgnoreCase("view_complaints"))
            {
                ...
                if(status.equalsIgnoreCase("success")){
                    ...
                    {
                        complaints[i]=ja1.getJSONObject(i).getString("complaint_des");
